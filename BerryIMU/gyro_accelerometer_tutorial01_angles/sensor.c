...
void enableIMU()
{
	...
	// BIT COMBINATION WAS CHANGED TO REFLECT OUR SENSOR
        writeAccReg(CTRL_REG1_XM, 0b01011111); //  z,y,x axis enabled, continuous update,  100Hz data rate

	// BIT COMBINATION WAS CHANGED TO REFLECT OUR SENSOR
	//  CTRL_REG2_XM WAS CHANGED TO CTRL_REG4_XM TO REFLECT OUR SENSOR 
	writeAccReg(CTRL_REG4_XM, 0b00110000); // +/- 16G full scale
	 ...
	 // BIT COMBINATION WAS CHANGED TO REFLECT OUR SENSOR
        writeGyrReg(CTRL_REG4_G, 0b10000000); // Continuos update, 2000 dps full scale
